...
void agent::IAMQPWorker::InitializeQueue()
{
...
void agent::IAMQPWorker::SetConsumerCallbacks()
{
...
void agent::IAMQPWorker::AddMessage(const void *_msg, std::uint32_t _size, std::string _exchange, std::string _key)
{
